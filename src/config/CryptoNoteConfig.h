...
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 120; // recommended : 20
...
const uint64_t EMISSION_SPEED_FACTOR_V2_HEIGHT               = 700000; // Date of fork ... 2019
...
const uint64_t MINIMUM_FEE                                   = UINT64_C(10); // recommended 0.01 coin

/* This section defines our minimum and maximum mixin counts required for transactions */
const uint64_t MINIMUM_MIXIN_V1                              = 0;
const uint64_t MAXIMUM_MIXIN_V1                              = 7; // recommeneded : 1

const uint64_t MINIMUM_MIXIN_V2                              = 0; //
const uint64_t MAXIMUM_MIXIN_V2                              = 1; // recommeneded : 1

const uint64_t MINIMUM_MIXIN_V3                              = 0; //
const uint64_t MAXIMUM_MIXIN_V3                              = 1; // recommeneded : 1

/* The heights to activate the mixin limits at */
const uint32_t MIXIN_LIMITS_V1_HEIGHT                        = 0;
const uint32_t MIXIN_LIMITS_V2_HEIGHT                        = 5000000; // unused
const uint32_t MIXIN_LIMITS_V3_HEIGHT                        = 5000000; // unused
...
const uint64_t MAX_EXTRA_SIZE_V2                             = 512;
const uint64_t MAX_EXTRA_SIZE_V2_HEIGHT                      = 5000000; // recommended : 0
...
const uint64_t DATABASE_READ_BUFFER_MB_DEFAULT_SIZE          = 128; // 128 MB - recommended : small
